                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="gapok_jabatan" value="<?php echo $row['gapok_jabatan'] ?>" onkeypress='return (event.charCode > 47 && event.charCode < 58) || event.charCode == 46'>
                        </div>
                        <div class="form-group">
                            <label for="tunjangan_jabatan">Tunjangan</label>
                            <input type="text" class="form-control" name="tunjangan_jabatan" value="<?php echo $row['tunjangan_jabatan'] ?>" onkeypress='return (event.charCode > 47 && event.charCode < 58) || event.charCode == 46'>
                        </div>
                        <div class="form-group">
                            <label for="uang_makan_perhari">Uang Makan Perhari</label>
                            <input type="text" class="form-control" name="uang_makan_perhari" value="<?php echo $row['uang_makan_perhari'] ?>" onkeypress='return (event.charCode > 47 && event.charCode < 58) || event.charCode == 46'>
                        </div>
